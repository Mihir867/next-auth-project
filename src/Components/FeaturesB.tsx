        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
          <div className="py-12 md:py-20">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
              <h2 className="h2 mb-4" style={{ fontSize: '30px' }}>Explore the features</h2>
            </div>
            ...
            <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-2 lg:grid-cols-3 items-start md:max-w-2xl lg:max-w-none">
              ...
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Custom Tests</h4>
                <p className="text-gray-600 text-center">Craft tailored assessments matching your job requirements.</p>
              </div>
              ...
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Automated Grading</h4>
                <p className="text-gray-600 text-center">Instantly assess candidate responses and save time.</p>
              </div>
              ...
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Skills Insights</h4>
              ...
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Candidate Management</h4>
                <p className="text-gray-600 text-center">Organize and track candidate progress effortlessly.</p>
              </div>
              ...
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Flexible Deployment</h4>
                <p className="text-gray-600 text-center">Seamlessly integrate into your existing hiring process.</p>
              </div>
              ...
              <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
                ...
                <h4 className="text-xl font-bold leading-snug tracking-tight mb-1">Secure Data Handling</h4>
                <p className="text-gray-600 text-center">Ensure confidentiality with encrypted data storage.</p>
              </div>
